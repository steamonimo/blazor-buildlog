...
dotnet.js:3  Error in mono_download_assets: Error: download 'http://localhost/_framework/dotnet.native.wasm' for dotnet.native.wasm failed 0 TypeError: Failed to fetch
Q @ dotnet.js:3
...
An @ blazor.webassembly.js:1
(anonym) @ (Index):20
dotnet.js:3  Uncaught (in promise) Error: download 'http://localhost/_framework/dotnet.native.wasm' for dotnet.native.wasm failed 0 TypeError: Failed to fetch
    at dotnet.js:3:9940
